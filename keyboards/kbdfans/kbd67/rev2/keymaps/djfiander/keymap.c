...
/* Keymap (Base Layer) Default Layer
   ...
   * |----------------------------------------------------------------|
   * |Ctl/Caps|  A|  S|  D|  F|  G|  H|  J|  K|  L|  ;|  '|Return|PgUp|
   * |----------------------------------------------------------------|
...
[_BL] = LAYOUT_65_ansi(
   ...
   * |      |   |   |   |   |   |LFT|DN| UP|  RT|   |   |        |    |
   * |----------------------------------------------------------------|
   * |        |   |   |   |   |Reset|   |   |   |   |  |Btn1|MsUp|Btn2|
   * |----------------------------------------------------------------|
   * |    |MO(PL)|    |                     |   |   |    |MsL|MsD|MsR |
   * `----------------------------------------------------------------'
   */
[_FL] = LAYOUT_65_ansi(
   KC_GRV,  KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9, KC_F10, KC_F11, KC_F12,          _______,KC_INSERT, \
   ...
   _______,_______,_______,_______,_______,RESET  ,_______,_______, _______,_______,_______,       KC_MS_BTN1,KC_MS_UP,KC_MS_BTN2, \
   _______,  MO(_PL), _______,                     _______,                     _______,_______,_______,KC_MS_LEFT,KC_MS_DOWN, KC_MS_RIGHT),
