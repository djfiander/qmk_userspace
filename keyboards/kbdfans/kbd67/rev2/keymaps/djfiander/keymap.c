...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FL] = LAYOUT_65_ansi(
        ...
        MO(_PL), _______, _______, _______, _______, _______,   _______, _______, _______, _______, _______, KC_BTN1, KC_MS_U, KC_BTN2,
        _______, _______, _______,                            _______,                   MO(_RL), MO(_PL), _______, KC_MS_L, KC_MS_D, KC_MS_R
    ),
    ...
    [_PL] = LAYOUT_65_ansi(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, S(KC_PSCR), _______, _______,          _______, _______, \
