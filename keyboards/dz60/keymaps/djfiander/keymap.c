...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_BL] = LAYOUT_60_ansi_split_bs_rshift(
		...
		MO(_FL),   KC_LGUI, KC_LALT,                   KC_SPC,                             KC_RALT, KC_RGUI, RCTL_T(KC_APP), MO(_FL)),
	...
	[_FL] = LAYOUT_60_ansi_split_bs_rshift(
		...
		_______,          _______, _______, _______, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,_______, _______, _______,
                MO(_PL),          _______, _______, _______, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END, _______, _______,          _______, _______,
		_______, _______, _______,                   _______,                                     MO(_RL), _______, _______, _______),

        [_PL] = LAYOUT_60_ansi_split_bs_rshift(
                _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
		_______,          _______, _______, _______, _______, _______, _______, _______, _______, _______, S(KC_PSCR), _______, _______, KC_INS,
