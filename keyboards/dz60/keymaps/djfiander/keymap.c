...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[BASE] = LAYOUT_60_ansi(
		...
		FL_CAPS, KC_LGUI, ALT_ESC,                  KC_SPC,                   ALT_ESC, KC_RGUI, MEH_APP,    FL_CAPS),

	[FUNC] = LAYOUT_60_ansi(
        _______,    KC_F1,      KC_F2,    KC_F3,      KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12, KC_DEL,
		CTL_ALT,    KC_MS_BTN2, KC_MS_UP, KC_MS_BTN1, _______, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_PSCR, _______, _______, KC_INS,
