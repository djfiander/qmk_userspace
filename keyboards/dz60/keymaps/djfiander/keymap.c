...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT_60_ansi_split_bs_rshift(
		...
		LT(1, KC_CAPS),   KC_LGUI, KC_LALT,                   KC_SPC,                             KC_RALT, KC_RGUI, MT(KC_RCTL, KC_APP), MO(1)),
	...
	LAYOUT_60_ansi_split_bs_rshift(
		...
		_______,          _______, _______, _______, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,_______, _______, _______,
                MO(2),            _______, _______, _______, _______, RESET,   _______, _______, _______, _______, _______,          _______, _______,
		...
		_______,          _______, _______, _______, RGB_HUI, RGB_TOG, _______, _______, _______, _______, _______, _______, _______, KC_INS,
