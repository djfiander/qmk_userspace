...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT_60_ansi_split_bs_rshift(
        ...
        KC_CAPS,          _______, _______, _______, _______, RESET, _______, _______, _______, _______, _______,          _______, _______,
		...
		_______,          _______, _______, _______, RGB_HUI, RGB_TOG, _______, _______, _______, _______, KC_PSCR, _______, _______, KC_INS,
