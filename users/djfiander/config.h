...
#define DJF_ANSI_65_BL 0
#define DJF_ANSI_65_FL 1
#define DJF_ANSI_65_PL 2
#define DJF_ANSI_65_RL 3
...
#define DJF_ANSI_65 \
{ \
    /* Keymap DJF_ANSI_65_BL: (Base Layer) Default Layer \
     * ,----------------------------------------------------------------. \
     * |  ` | 1|  2|  3|  4|  5|  6|  7|  8|  9|  0|  -|  =|Backsp |Del | \
     * |----------------------------------------------------------------| \
     * |Tab  |  Q|  W|  E|  R|  T|  Y|  U|  I|  O|  P|  [|  ]|  \  |Home| \
     * |----------------------------------------------------------------| \
     * |Ctrl     |A|  S|  D|  F|  G|  H|  J|  K|  L|  ;|  '|CTL/Ret|PgUp| \
     * |----------------------------------------------------------------| \
     * |Shift/( |  Z|  X|  C|  V|  B|  N|  M|  ,|  .| /|Shift/)| Up|PgDn| \
     * |----------------------------------------------------------------| \
     * | Fn |Win |Alt/Esc |        Space      |Alt|Win| Meh|Lef|Dow|Rig | \
     * `----------------------------------------------------------------' \
     */ \
    [DJF_ANSI_65_BL] = LAYOUT_65_ansi( \
 ...
 \
    ...
    [DJF_ANSI_65_FL] = LAYOUT_65_ansi( \
        ...
        KC_MEH,          _______, _______, _______, _______, _______, _______,   _______, _______, _______, _______,         _______, _______, _______, \
        _______, MO(DJF_ANSI_65_PL),  _______,                            _______,                   _______, _______, MO(DJF_ANSI_65_RL), _______, _______, _______), \
 \
    /* Keymap DJF_ANSI_65_PL: Paging Layer \
     * ,----------------------------------------------------------------. \
     * |    |   |   |   |   |   |   |   |   |   |   |   |   |      |    | \
     * |----------------------------------------------------------------| \
     * |       |   |   |   |   |   |   |   |   |   |      |  |  |  |    | \
 ...
 \
    /* Keymap DJF_ANSI_65_RL: Reset Layer \
     * ,----------------------------------------------------------------. \
     * |    |   |   |   |   |   |   |   |   |   |   |   |   |      |    | \
     * |----------------------------------------------------------------| \
     * |    |   |   |EE_CLR|RGB_Tog|  |  |  |  |   |      |  |  |  |    | \
     ...
     * `----------------------------------------------------------------' \
     */ \
    [DJF_ANSI_65_RL] = LAYOUT_65_ansi( \
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  \
        _______, _______, _______, EE_CLR,  RGB_TOG, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
